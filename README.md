...
The Fyfylian Candy-Machine-Mint project is designed to let users fork, customize, and deploy FYFY.IO candy machine mint app to a custom domain, ultra fast.
